...
{
   public abstract class PrimitiveDeBaseAnimÈe2 : PrimitiveDeBase2, IModele3d
   {
      ...
      protected PrimitiveDeBaseAnimÈe2(Game jeu, float homothÈtieInitiale, Vector3 rotationInitiale, Vector3 positionInitiale, float intervalleMAJ)
